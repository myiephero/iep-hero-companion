  ...
  return (
    <MobileAppShell>
      <SafeAreaFull>
        ...
        <PremiumLargeHeader
          title="Schedule"
          subtitle="Manage your meetings and appointments"
          rightAction={
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        Book your next client appointment
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="text-center py-16">
                ...
                <div className="space-y-4 max-w-sm mx-auto">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 leading-relaxed">
                    Your calendar is clear. Ready to schedule your first meeting with a client family?
                  </p>
                  <Button 
                    onClick={() => navigate('/advocate/schedule/new')}
            ...
            <PremiumCard variant="elevated" className="p-6">
              ...
              <div className="text-center py-8 border-2 border-dashed border-gray-200 dark:border-gray-700 rounded-xl">
                <div className="text-gray-500 dark:text-gray-400">
                  <p className="text-sm font-medium mb-1">No tasks scheduled for today</p>
                  <p className="text-xs">Tasks will appear here as you schedule meetings</p>
                </div>
              </div>
            </PremiumCard>
            ...
            <PremiumCard variant="glass" className="p-6">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 dark:text-gray-400">
                    Meeting analytics for this week
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-blue-50 to-blue-100 dark:from-blue-950/50 dark:to-blue-900/50 border border-blue-200/50 dark:border-blue-800/50">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-semibold text-blue-800 dark:text-blue-200">This Week</span>
                  </div>
