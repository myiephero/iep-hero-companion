...
export const ADVOCATE_STRIPE_PLANS: Record<string, StripePlanConfig> = {
  ...
  pro: {
    priceId: 'price_1Rr3hR8iKZXV0srZ5lPscs0p', // PRODUCTION: Advocate Pro $149/month
    amount: 149,
    interval: 'month',
  ...
  'pro-annual': {
    priceId: 'price_1S6eXk8iKZXV0srZk5htFfFP', // Advocate Pro Annual $1,188/year
    amount: 1188, // $99 * 12 = $1,188
    interval: 'year',
