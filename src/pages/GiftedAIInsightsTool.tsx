  ...
  const generateInsightsMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      toast({
        ...
        description: "Comprehensive gifted insights have been generated for your child",
      });
    },
    onError: (error) => {
      ...
      <div className="container mx-auto px-4 py-8 max-w-5xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            Get comprehensive AI-powered insights and recommendations based on {selectedStudentName}'s gifted and 2e profile. Our advanced analysis provides evidence-based strategies and personalized educational recommendations.
          </p>
        </div>
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          <Button asChild size="sm" variant="outline">
                            <Link to="/parent/gifted-tools/cognitive">Complete Cognitive</Link>
                          </Button>
                          <Button asChild size="sm" variant="outline">
                            <Link to="/parent/gifted-tools/academic">Complete Academic</Link>
                          </Button>
                          <Button asChild size="sm" variant="outline">
                            <Link to="/parent/gifted-tools/creative">Complete Creative</Link>
                          </Button>
                          <Button asChild size="sm" variant="outline">
                            <Link to="/parent/gifted-tools/leadership">Complete Leadership</Link>
                          </Button>
                        </div>
                      </div>
                    </div>
            ...
            <div className="flex gap-4">
              <Button 
                ...
                onClick={() => {
                  ...
                  const reportContent = `Gifted AI Insights Report for ${selectedStudentName}\n\n` +
                  ...
                  a.href = url;
                  a.download = `${selectedStudentName}-gifted-ai-insights-${new Date().toISOString().split('T')[0]}.txt`;
                  a.click();
...
export default GiftedAIInsightsTool;